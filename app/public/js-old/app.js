...
function loadAppJs(page) {
    
    var swipekeys = Object.keys(swipers);
    for (let i = 0; i < swipekeys.length; i++)
    {
        swipers[swipekeys[i]].destroy();
    }
    ...
    switch (page) {
        ...
        case "homepage":
            ...
            /* carousel */
            if ($('.swiper-users').length)
            {
                swipers['homepage1'] = new Swiper('.swiper-users', {
                    slidesPerView: 'auto',
                    spaceBetween: 15,
                    pagination: 'false'
                });
            ...
            if ($('.addsendcarousel').length)
            {
                swipers['homepage2'] = new Swiper('.addsendcarousel', {
                    slidesPerView: '4',
                    spaceBetween: 15,
                    pagination: {
            ...
            if ($('#more-expand-btn').length)
            {
                $('#more-expand-btn').off('click');
        ...
        case "landing":
            /* carousel */
            swipers['landing'] = new Swiper('.introduction', {
                autoplay: true,
                pagination: {
                    el: '.swiper-pagination',
                },
